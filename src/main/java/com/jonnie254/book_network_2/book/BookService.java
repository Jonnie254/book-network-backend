...
import com.jonnie254.book_network_2.file.FileStorageService;
import com.jonnie254.book_network_2.history.BookTransactionHistory;
import com.jonnie254.book_network_2.history.BookTransactionHistoryRepository;
...
import static com.jonnie254.book_network_2.book.BookSpecification.withOwnerId;
...
public class BookService {
    ...
    public Integer approveReturnBorrowedBook(Integer bookId, Authentication connectedUser) {
        Book book = bookRepository.findById(bookId)
                .orElseThrow(() -> new EntityNotFoundException("Book not found with the id::" + bookId));
        if (book.isArchived() || !book.isShareable()) {
            throw new OperationNotPermittedException("You are not allowed to approve return of this book");
        }
        User user = ((User) connectedUser.getPrincipal());
        if (Objects.equals(book.getOwner().getId(), user.getId())) {
            throw new OperationNotPermittedException("You are not allowed to approve return of this book");
        ...
        BookTransactionHistory bookTransactionHistory = bookTransactionHistoryRepository.findbyBookIdAndOwnerId(bookId, user.getId())
                .orElseThrow(() -> new OperationNotPermittedException("The book is not yet returned. You cannot approve"));
